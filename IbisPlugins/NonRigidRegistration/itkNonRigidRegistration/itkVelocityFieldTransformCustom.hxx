...
template<class TScalarType, unsigned int NDimensions, unsigned int VSplineOrder>
void VelocityFieldTransformCustom<TScalarType, NDimensions, VSplineOrder>
::ComputeJacobianWithRespectToParameters(const InputPointType &, JacobianType &) const
{
}

template<class TScalarType, unsigned int NDimensions, unsigned int VSplineOrder>
void VelocityFieldTransformCustom<TScalarType, NDimensions, VSplineOrder>
::ComputeJacobianWithRespectToPosition(const InputPointType & x, JacobianType & jacobian) const
{
}
